...
import { SESSIONS_DATA } from '../data/courseData';
...
const WHATSAPP_GROUP_LINK = "https://chat.whatsapp.com/Du3KC8mPXLjK2q7b0vUtf7?mode=gi_t";
...
const RAZORPAY_KEY_ID = (import.meta.env.VITE_RAZORPAY_KEY_ID as string) || "rzp_test_517j3yqW5eK8yX"; // default test key or user key
...
export const RegistrationModal: React.FC<RegistrationModalProps> = ({
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    sendToGoogleSheet({
      ...
      niche: primaryNiche,
      paymentId: 'Initiating Razorpay ₹1',
    ...
    if (typeof window !== 'undefined' && window.Razorpay) {
      try {
        const options = {
          ...
          description: 'Live Masterclass Ticket Pass (₹1)',
          ...
          handler: function (response: any) {
            finalizeSuccess(`Paid ₹1 (Razorpay: ${response.razorpay_payment_id || 'Success'})`);
          },
          modal: {
            ondismiss: function () {
              setIsProcessingPayment(false);
    ...
    setTimeout(() => {
      finalizeSuccess('Paid ₹1 (Razorpay)');
    }, 1200);
  };
          ...
          <div className="text-center space-y-5">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 mt-1">
                Your ₹1 payment was successful. Session details and live link will be sent to your phone.
              </p>
            </div>
