...
export const CountdownTimerSection: React.FC<CountdownTimerSectionProps> = ({ onRegisterClick }) => {
  // Target date: September 10, 2026 at 20:00:00 (8:00 PM) IST or dynamic fallback
  ...
  useEffect(() => {
    const calculateTimeLeft = () => {
      // Calculate target to 10 Sep 8:00 PM
      const now = new Date();
      let targetYear = now.getFullYear();
      let targetDate = new Date(targetYear, 8, 10, 20, 0, 0); // Month 8 is September (0-indexed)

      // If already past this year's Sept 10, set for next year or maintain realistic countdown
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-8">
          ...
          <div className="text-center lg:text-left space-y-2 max-w-md">
            ...
            <h3 className="text-2xl sm:text-3xl font-black text-white tracking-tight font-heading">
              Session Starts on <span className="text-[#f5a623]">10-Sep @ 08:00 PM</span>
            </h3>
