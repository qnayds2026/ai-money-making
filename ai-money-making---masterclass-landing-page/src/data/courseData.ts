...
export const FAQS_DATA: FaqItem[] = [
  ...
  {
    question: 'Why is the webinar priced at only ₹1?',
    answer: 'The ₹1 fee is intentionally kept affordable so that anyone who is genuinely interested in learning AI can join the session. It also helps us attract serious learners who are willing to invest a small amount of money in their learning journey.',
    category: 'general'
  }
];
